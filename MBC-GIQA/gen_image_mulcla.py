...
parser.add_argument('--num_class', default=8, type=int, help='number of classes')
...
def main():
    ...
    trainset = CustomDataset(root_path=args.root_path, train_file=args.train_file, test_file=args.test_file, train_size=args.train_size, isTrain=True, if_gt=args.add_gt, num_class=args.num_class)
    trainloader = data.DataLoader(trainset, batch_size=args.train_batch, shuffle=True, num_workers=args.workers)

    testset = CustomDataset(root_path=args.root_path, train_file=args.train_file, test_file=args.test_file, train_size=args.train_size, isTrain=False, if_gt=args.add_gt, num_class=args.num_class)
...
#        image_file = open("/mnt/blob/datasets/generate_results/stylegan_trylist.txt")
#        image_list = image_file.readlines()

#        for index in range(0,360):
#            a = float(outputs.squeeze(1)[index])
#            b = float(targets[index])
#            a = int(10000*a)
#            if b < 0:
#               b = 0.9999
#            b = int(10000*b)
#            c = str(a)+"_"+str(b)+".png"
#            ori_image_name = image_list[index].replace("\n", "")
#            root_path = "/mnt/blob/datasets/generate_results/stylegan_test/"
#            out_path = "/mnt/blob/datasets/generate_results/stylegan_test_out/"
#            string = "cp "+root_path+ori_image_name+" "+out_path+c
#            os.system(string)
